...
const CallToActionSection = () => {
  return (
    <div className='relative py-24'>
        ...
        <motion.div initial={{opacity:0, y:20}} transition={{duration:0.5}} whileInView={{opacity:1, y:0}} viewport={{once: true}} className='relative max-w-4xl xl:max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 py-12'>
            <div className='flex flex-col md:flex-row justify-between item-center'>
                ...
                <div>
                    ...
                    <div className='flex justify-center md:justify-start gap-4'>
                        ...
                        <Link href='/signup' className='inline-block text-white bg-secondary-500 rounded-lg px-6 py-3 font-semibold hover:bg-secondary-600' scroll={false}>Sign Up</Link>
                    </div>
                </div>
            </div>
        </motion.div>
