...
const DiscoverSection = () => {
  return (
    <motion.div initial='hidden' whileInView='visible' viewport={{once: true, amount: 0.8}} variants={containerVariants} className='py-12 bg-white mb-16'>
               ...
               {[
                {
                    ...
                    description: "Browse through our extensive collection of rental properties in your desired locations."
                },
                {
                    imageSrc: "/landing-icon-wand.png",
                    title: "Book Your Rental",
                    description: "once you've found the prefect rental property, easily book it online with just a few clicks."
                },
                {
                    imageSrc: "/landing-icon-wand.png",
    ...
    description:string
        ...
        <div className='px-4 py-12 shadow-lg rounded-lg bg-primary-50 md:h-72 '>
            <div className='bg-primary-700 p-[0.6rem] rounded-full mb-4 h-10 w-10 mx-auto'>
                <Image src={imageSrc} width={400} height={400} className='w-full h-full' alt={title} />
            </div>
